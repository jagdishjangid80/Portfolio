export const SKILLS = [
  {
    title: "Frontend",
    iconUrl: "./assets/images/frontend-icon.png",
    skills: [
  ...
  {
    title: "Backend",
    iconUrl: "./assets/images/backend-icon.png",
    skills: [
  ...
  {
    title: "Tools",
    iconUrl: "../assets/images/tools-icon.png",
    skills: [
  ...
  {
    title: "Soft Skills",
    iconUrl: "./assets/images/skills-icon.png",
    skills: [
...
export const WORK_EXPERIENCE = [
  {
    title: "Frontend Developer Intern at Lgeom Pvt",
